...
function AlertDialogOverlay({
  ...
  return (
    <AlertDialogPrimitive.Backdrop
      ...
      className={cn(
        'data-open:animate-in data-closed:animate-out data-closed:fade-out-0 data-open:fade-in-0 fixed inset-0 isolate z-50 bg-slate-950/30 duration-150 supports-backdrop-filter:backdrop-blur-sm dark:bg-slate-950/65',
        className,
      )}
      {...props}
    />
